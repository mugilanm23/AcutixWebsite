      ...
      <div className="aboutus-container">
        ...
        <div className="vision-mission">
          <div className="card">
            <h2>Our Vision</h2>
            <p>
              To become the go-to partner for small businesses seeking digital transformation, known for our expertise, affordability, and customer-centric approach.
            </p>
          </div>
          <div className="card">
            <h2>Our Mission</h2>
            <p>
              To empower small businesses through affordable technology solutions, enhancing their operational efficiency and driving growth.
            </p>
          </div>
        </div>
  ...
  {[
    {
      title: "Excellence",
      description:
        "We are committed to delivering top-tier quality in everything we do. Excellence is not just a goal—it’s a standard.",
    },
    {
      title: "Innovation",
      description:
        "We believe in pushing boundaries and thinking ahead. Our culture encourages creative problem-solving and smart solutions.",
    },
    {
      title: "Education",
      description:
        "We value learning as a continuous journey. By fostering curiosity and growth, we invest in knowledge and long-term success.",
    },
    {
      title: "Collaboration",
      description:
        "We grow stronger together. Open communication and teamwork are the foundation of our progress and innovation.",
    },
  ].map((value, index) => (
